...
async function main() {
  ...
  const mockNFTMarketplace = await hre.ethers.getContractFactory("AddressStorage");
  ...
  console.log("Address storage marketplace deployed to:", await deployedNFT.getAddress()) // .address); depreciated
